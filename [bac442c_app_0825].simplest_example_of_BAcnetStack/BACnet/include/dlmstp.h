...
#define MAX_PDU_MSTP (MAX_NPDU+MAX_APDU_MSTP)
#define MAX_MPDU_MSTP (MAX_HEADER_MSTP + MAX_PDU_MSTP)
...
extern "C" {
    ...
    void dlmstp_set_max_info_frames(struct mstp_port_struct_t *mstp_port,uint8_t max_info_frames);
    ...
    /* MAC address 0-127 */
    void dlmstp_set_mac_address(struct mstp_port_struct_t *mstp_port, uint8_t my_address);
