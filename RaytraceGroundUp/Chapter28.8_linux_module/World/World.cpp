...
void World::build()
{
    ...
    fishbowl_ptr1->set_glass_air_material(glass_air_ptr) ;
    fishbowl_ptr1->set_water_air_material(water_air_ptr) ;
    fishbowl_ptr1->set_water_glass_material(water_glass_ptr) ;
