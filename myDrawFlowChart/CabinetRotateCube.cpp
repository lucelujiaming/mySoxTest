// CabinetRotateCube.cpp: implementation of the CCabinetRotateCube class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CCabinetRotateCube, CObject, 1)
...
void CCabinetRotateCube::DrawObject(CDC* pDC)//绘制图形
{
	cube.Draw(pDC);
}
...
void CCabinetRotateCube::Draw( CDC *pdc, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CCabinetRotateCube::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CCabinetRotateCube::Move( int cx, int cy )
{
...
/************************************************************************/
void CCabinetRotateCube::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CCabinetRotateCube::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CCabinetRotateCube::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CCabinetRotateCube::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CCabinetRotateCube::AdjustStartAndEnd()
{
...
int CCabinetRotateCube::GetAdjustPoint()
{
...
/************************************************************************/
void CCabinetRotateCube::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CCabinetRotateCube::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CCabinetRotateCube::LoadParamsFromJSON(cJSON * objJSON)
{
