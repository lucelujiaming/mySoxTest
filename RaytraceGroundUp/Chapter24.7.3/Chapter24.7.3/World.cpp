...
void World::build(char * file_name)
{
	...
	Torus * one_torus_ptr = new Torus(100, 20);
	one_torus_ptr->set_material(reflective_ptr1);

	Instance* instance_one_torus_ptr = new Instance;
	//add whole grid up to this level
	instance_one_torus_ptr->set_object(one_torus_ptr);
	instance_one_torus_ptr->set_material(reflective_ptr1);
	// instance_one_torus_ptr->scale(400.0, 400.0, 400.0);
	instance_one_torus_ptr->compute_bounding_box();
	add_object(instance_one_torus_ptr);

	Torus * two_torus_ptr = new Torus(100, 20);
	two_torus_ptr->set_material(reflective_ptr1);

	Instance* instance_two_torus_ptr = new Instance;
	//add whole grid up to this level
	instance_two_torus_ptr->set_object(two_torus_ptr);
	instance_two_torus_ptr->set_material(reflective_ptr1);
	// instance_two_torus_ptr->scale(400.0, 400.0, 400.0);
	instance_two_torus_ptr->rotate_z(90);
	instance_two_torus_ptr->translate(0.0, 0.0, -50.0);
	instance_two_torus_ptr->compute_bounding_box();
	add_object(instance_two_torus_ptr);
