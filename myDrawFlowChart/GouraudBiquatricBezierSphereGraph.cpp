// GouraudBiquatricBezierSphereGraph.cpp: implementation of the CGouraudBiquatricBezierSphereGraph class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CGouraudBiquatricBezierSphereGraph, CObject, 1)

/************************************************************************/
/* 功能：建构函数。设定了连接点。                                       */
/************************************************************************/
CGouraudBiquatricBezierSphereGraph::CGouraudBiquatricBezierSphereGraph()
{
...
void CGouraudBiquatricBezierSphereGraph::DoubleBuffer(CDC* pDC)
{
...
void CGouraudBiquatricBezierSphereGraph::DrawObject(CDC* pDC)//绘制图形
{
...
void CGouraudBiquatricBezierSphereGraph::InitializeLightingScene(void)//初始化光照环境
{
	//设置光源属性
...
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::Draw( CDC *pDC, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::Move( int cx, int cy )
{
...
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CGouraudBiquatricBezierSphereGraph::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CGouraudBiquatricBezierSphereGraph::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CGouraudBiquatricBezierSphereGraph::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::AdjustStartAndEnd()
{
...
int CGouraudBiquatricBezierSphereGraph::GetAdjustPoint()
{
...
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CGouraudBiquatricBezierSphereGraph::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CGouraudBiquatricBezierSphereGraph::LoadParamsFromJSON(cJSON * objJSON)
{
