...
class CAntiAliasedBumpTextureSphere//球类
{
public:
	...
	void Draw(CDC* pDC, CAntiAliasedBumpTextureZBuffer* pZBuffer);//绘制图形
public:
	CColorP3 Ver[26];//球面二次控制点
	CAntiAliasedBumpTextureBiquatricBezierPatch bezier;//曲面片
private:
	CPatch Pat[8];//球面曲面片数	
};
