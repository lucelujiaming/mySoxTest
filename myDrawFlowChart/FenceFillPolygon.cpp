...
void CFenceFillPolygon::DrawObject(CDC* pDC)
{
	...
	// 为了计算方便，栅栏通常取多边形某一个顶点的垂线。这里取得是P[4]点的垂线。
...
/************************************************************************/
/* 栅栏算法和边填充算法有一个共同的前提，就是填充色和背景色互为补色。   */
/* 因为对一个像素两次取补会恢复为原色。产生负负得正的效果。             */
/* 这就是栅栏算法和边填充算法能够工作的关键。                           */
/************************************************************************/
/* 而栅栏算法和边填充算法的区别在于：                                   */
/* 边填充算法处理的是边右侧的所有像素。                                 */
/* 而栅栏算法处理的是栅栏和边之间的像素。因此上，栅栏算法不需要边框。   */
/************************************************************************/
/* 有了上面的预设前提。这个算法的原理就变得非常简单，                   */
/*   如果边在栅栏左边，就处理从这条边到栅栏之间的像素。                 */
/*   如果边在栅栏右边，就处理从栅栏到这条边之间的像素。                 */
/*   如果边穿过栅栏，则该边分为两段。                                   */
/*   边在栅栏左边的部分，处理该部分到栅栏之间的像素。                   */
/*   边在栅栏右边的部分，处理栅栏到该部分之间的像素。                   */
/* 这就是这个栅栏填充算法的原理。                                       */
/************************************************************************/
