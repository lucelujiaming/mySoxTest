// BackfaceCullRotateCube.cpp: implementation of the CBackfaceCullRotateCube class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CBackfaceCullRotateCube, CObject, 1)
...
/************************************************************************/
void CBackfaceCullRotateCube::Draw( CDC *pdc, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CBackfaceCullRotateCube::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CBackfaceCullRotateCube::Move( int cx, int cy )
{
...
/************************************************************************/
void CBackfaceCullRotateCube::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CBackfaceCullRotateCube::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CBackfaceCullRotateCube::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CBackfaceCullRotateCube::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CBackfaceCullRotateCube::AdjustStartAndEnd()
{
...
int CBackfaceCullRotateCube::GetAdjustPoint()
{
...
/************************************************************************/
void CBackfaceCullRotateCube::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CBackfaceCullRotateCube::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CBackfaceCullRotateCube::LoadParamsFromJSON(cJSON * objJSON)
{
