...
void World::build()
{
    ...
    Phong * phong_ptrl = new Phong;
    phong_ptrl->set_ka(0.25);
    phong_ptrl->set_kd(0.65);
    phong_ptrl->set_cd(1, 1, 0);

    Sphere* sphere_ptrl = new Sphere(Point3D(10, -5, 0), 27);
    sphere_ptrl->set_material(phong_ptrl);
