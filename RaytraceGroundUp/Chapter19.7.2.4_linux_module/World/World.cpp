...
//    add_object(sphere_ptr1);
    ...
    OpenCylinderPartConvex * opencylinderpartconcex_ptr1 = new OpenCylinderPartConvex();
    opencylinderpartconcex_ptr1->set_material(matte_ptr2);
    add_object(opencylinderpartconcex_ptr1);
