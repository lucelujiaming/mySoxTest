// ArbitraryRotateCube.cpp: implementation of the CArbitraryRotateCube class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CArbitraryRotateCube, CObject, 1)

/************************************************************************/
/* 功能：建构函数。设定了连接点。                                       */
/************************************************************************/
CArbitraryRotateCube::CArbitraryRotateCube()
{
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CArbitraryRotateCube::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CArbitraryRotateCube::Move( int cx, int cy )
{
...
/************************************************************************/
void CArbitraryRotateCube::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CArbitraryRotateCube::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CArbitraryRotateCube::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CArbitraryRotateCube::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CArbitraryRotateCube::AdjustStartAndEnd()
{
...
int CArbitraryRotateCube::GetAdjustPoint()
{
...
/************************************************************************/
void CArbitraryRotateCube::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CArbitraryRotateCube::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CArbitraryRotateCube::LoadParamsFromJSON(cJSON * objJSON)
{
