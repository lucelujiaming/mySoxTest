// PhongLightingBiquatricBezierSphereGraph.cpp: implementation of the CPhongLightingBiquatricBezierSphereGraph class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CPhongLightingBiquatricBezierSphereGraph, CObject, 1)

/************************************************************************/
/* 功能：建构函数。设定了连接点。                                       */
/************************************************************************/
CPhongLightingBiquatricBezierSphereGraph::CPhongLightingBiquatricBezierSphereGraph()
{
...
void CPhongLightingBiquatricBezierSphereGraph::DoubleBuffer(CDC* pDC)
{
...
void CPhongLightingBiquatricBezierSphereGraph::DrawObject(CDC* pDC)//绘制图形
{
...
void CPhongLightingBiquatricBezierSphereGraph::InitializeLightingScene(void)//初始化光照环境
{
	//设置光源属性
...
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::Draw( CDC *pDC, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::Move( int cx, int cy )
{
...
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CPhongLightingBiquatricBezierSphereGraph::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CPhongLightingBiquatricBezierSphereGraph::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CPhongLightingBiquatricBezierSphereGraph::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::AdjustStartAndEnd()
{
...
int CPhongLightingBiquatricBezierSphereGraph::GetAdjustPoint()
{
...
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CPhongLightingBiquatricBezierSphereGraph::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CPhongLightingBiquatricBezierSphereGraph::LoadParamsFromJSON(cJSON * objJSON)
{
