...
//    add_object(sphere_ptr1);
    ...
    OpenCylinderConcave * opencylinderconcave_ptr1 = new OpenCylinderConcave(-1, 2, 1);
    opencylinderconcave_ptr1->set_material(matte_ptr2);
    add_object(opencylinderconcave_ptr1);
