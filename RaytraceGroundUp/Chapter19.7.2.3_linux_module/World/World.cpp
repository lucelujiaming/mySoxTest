...
//    add_object(sphere_ptr1);
    ...
    OpenCylinderPartConcave * opencylinderpartconcave_ptr1 = new OpenCylinderPartConcave();
    opencylinderpartconcave_ptr1->set_material(matte_ptr2);
    add_object(opencylinderpartconcave_ptr1);
