...
CAntiAliasedBumpTextureSphere::CAntiAliasedBumpTextureSphere(void)
{
...
void CAntiAliasedBumpTextureSphere::Draw(CDC* pDC, CAntiAliasedBumpTextureZBuffer* pZBuffer)//绘制图形
{
	CColorP3 P[3][3];//三维顶点
	double W[3][3];//权因子
