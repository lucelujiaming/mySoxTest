...
/************************************************************************/
void CParallelogram::Draw( CDC *pdc, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CParallelogram::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CParallelogram::LoadParamsFromJSON(cJSON * objJSON)
{
