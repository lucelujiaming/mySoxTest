// PhongBiquatricBezierSphereGraph.cpp: implementation of the CPhongBiquatricBezierSphereGraph class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CPhongBiquatricBezierSphereGraph, CObject, 1)

/************************************************************************/
/* 功能：建构函数。设定了连接点。                                       */
/************************************************************************/
CPhongBiquatricBezierSphereGraph::CPhongBiquatricBezierSphereGraph()
{
...
void CPhongBiquatricBezierSphereGraph::DoubleBuffer(CDC* pDC)
{
...
void CPhongBiquatricBezierSphereGraph::InitializeLightingScene(void)//初始化光照环境
{
	//设置光源属性
...
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::Draw( CDC *pDC, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::Move( int cx, int cy )
{
...
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CPhongBiquatricBezierSphereGraph::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CPhongBiquatricBezierSphereGraph::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CPhongBiquatricBezierSphereGraph::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::AdjustStartAndEnd()
{
...
int CPhongBiquatricBezierSphereGraph::GetAdjustPoint()
{
...
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CPhongBiquatricBezierSphereGraph::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CPhongBiquatricBezierSphereGraph::LoadParamsFromJSON(cJSON * objJSON)
{
