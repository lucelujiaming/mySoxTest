...
void World::build()
{
    ...
    // Only Matte supports path_shade 
    Matte * matte_plane_ptr = new Matte;
    matte_plane_ptr->set_cd(0.5, 0.0, 0.5);
    matte_plane_ptr->set_ka(0.25);
    matte_plane_ptr->set_kd(0.8);
    MultiJittered * multi_jitter_ptr = new MultiJittered(num_samples);
    multi_jitter_ptr->map_samples_to_hemisphere(1);
    matte_plane_ptr->set_sampler(multi_jitter_ptr);

    Matte * matte_sphere1_ptr = new Matte;
    matte_sphere1_ptr->set_cd(0.75, 1.0, 0.0);
    matte_sphere1_ptr->set_ka(0.25);
    matte_sphere1_ptr->set_kd(0.8);
    matte_sphere1_ptr->set_sampler(multi_jitter_ptr);

    //Matte * matte_sphere2_ptr = new Matte;
    //matte_sphere2_ptr->set_cd(0.0, 0.5, 1.0);
    //matte_sphere2_ptr->set_ka(0.25);
    //matte_sphere2_ptr->set_kd(0.8);
    //matte_sphere2_ptr->set_sampler(multi_jitter_ptr);

    //Sphere *sphere_ptr = new Sphere;
    //sphere_ptr->set_center(-10, -30, 50);
    //sphere_ptr->set_radius(240.0);
    //sphere_ptr->set_color(0.5, 0.0, 0.0);
    //sphere_ptr->set_material(matte_sphere1_ptr);
    ...
    //sphere_ptr->set_material(matte_sphere2_ptr);
    //add_object(sphere_ptr);
