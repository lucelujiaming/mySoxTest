#include "stdafx.h"
#include "RationalQuadraticBezierSphere.h"
#include "math.h"

CRationalQuadraticBezierSphere::CRationalQuadraticBezierSphere(void)
{
...
void CRationalQuadraticBezierSphere::ReadVertex(void)//读入点表
{
