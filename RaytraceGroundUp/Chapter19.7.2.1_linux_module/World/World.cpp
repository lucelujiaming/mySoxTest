...
//    add_object(sphere_ptr1);
    ...
    OpenCylinderConvex * opencylinderconvex_ptr1 = new OpenCylinderConvex(-1, 2, 1);
    opencylinderconvex_ptr1->set_material(matte_ptr2);
    add_object(opencylinderconvex_ptr1);
