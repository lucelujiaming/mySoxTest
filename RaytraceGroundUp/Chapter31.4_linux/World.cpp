...
void World::build()
{
	...
	noise_bunny_ptr->set_lacunarity(8);

	//the texture:
	FBmTexture* fBm_texture_bunny_ptr = new FBmTexture(noise_bunny_ptr);
	...
	noise_box_ptr->set_gain(0.4);
	noise_box_ptr->set_lacunarity(8);

	//the texture:
	FBmTexture* fBm_texture_box_ptr = new FBmTexture(noise_box_ptr);
