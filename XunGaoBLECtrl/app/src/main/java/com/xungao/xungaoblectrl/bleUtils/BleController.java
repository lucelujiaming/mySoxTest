package com.xungao.xungaoblectrl.bleUtils;
...
import com.xungao.xungaoblectrl.bleUtils.callback.BleDevceScanCallback;
...
import com.xungao.xungaoblectrl.bleUtils.request.ReceiverRequestQueue;
...
/**
 * Created by lucelu on 2024/4/15.
 */
...
public class BleController {
    ...
    public void WriteBuffer(String value, OnWriteCallback writeCallback) {
        ...
        if (mBleGattCharacteristic == null) {
            // 根据服务UUID和发送UUID,获取一个特征Characteristic
