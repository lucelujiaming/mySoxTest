// RationalQuadraticBezierSphereGraph.cpp: implementation of the CRationalQuadraticBezierSphereGraph class.
//
//////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////
// IMPLEMENT_SERIAL(CRationalQuadraticBezierSphereGraph, CObject, 1)
...
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::Draw( CDC *pdc, BOOL bShowSelectBorder )
{
	AdjustFocusPoint();
...
/* 功能：选中绘制函数。绘制了连接点。                                   */
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::DrawFocus( CDC *pdc )
{
	// 画笔为虚线，线宽为1，颜色为黑色。
...
/* 功能： 移动处理函数。                                                */
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::Move( int cx, int cy )
{
...
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::AdjustSize( CPoint &pt )
{
...
/* 功能：判断是否在图元区域内。                                         */
/************************************************************************/
bool CRationalQuadraticBezierSphereGraph::IsIn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
int CRationalQuadraticBezierSphereGraph::IsConnectOn(CAdjustPoint *pt)
{
	CAdjustPoint *connPoint = NULL;
	for(int i = 0; i < CCONNECTPOINT_RECT_MAX; i++)
	{
...
/************************************************************************/
bool CRationalQuadraticBezierSphereGraph::IsOn( CPoint &pt )
{
	AdjustStartAndEnd();
...
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::AdjustStartAndEnd()
{
...
int CRationalQuadraticBezierSphereGraph::GetAdjustPoint()
{
...
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::AdjustFocusPoint()
{
	CAdjustPoint *connPoint = NULL;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CRationalQuadraticBezierSphereGraph::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CRationalQuadraticBezierSphereGraph::LoadParamsFromJSON(cJSON * objJSON)
{
