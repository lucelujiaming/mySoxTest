...
CBicubicBezierSphere::CBicubicBezierSphere(void)
{
...
void CBicubicBezierSphere::Draw(CDC* pDC)//绘制图形
{
	CP3 P[4][4];//控制点数组用作曲面片接口
	CBicubicBezierPatch bezier;//曲面片对象
	// 使用透视投影
	bezier.projection.usePerspectiveProjection();
