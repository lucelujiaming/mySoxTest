...
/************************************************************************/
void CEnd::Draw(CDC *pdc, BOOL bShowSelectBorder)
{
	AdjustFocusPoint();
...
{
	bool flag = false;
	CRect rectEnd = CRect( m_Start, m_End );
	if(rectEnd.PtInRect( pt ))
	{
		flag = true;
	}
	return flag;
...
/* 功能：串行化操作。                                                   */
/************************************************************************/
void CEnd::SaveParamsToJSON(cJSON * objJSON)
{
//	if(ar.IsStoring())
//	{
...
void CEnd::LoadParamsFromJSON(cJSON * objJSON)
{
